...
class CocaColaFetcher(CompanyFetcher):
    """The Coca-Cola Company 爬蟲"""

    company_id = "coca_cola"
    company_name = "The Coca-Cola Company"
    news_url = "https://www.thecoca-colacompany.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.thecoca-colacompany.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from The Coca-Cola Company")
        return documents
