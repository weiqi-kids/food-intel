...
class TysonFetcher(CompanyFetcher):
    """Tyson Foods 爬蟲"""

    company_id = "tyson"
    company_name = "Tyson Foods"
    news_url = "https://www.tysonfoods.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.tysonfoods.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from Tyson Foods")
        return documents
