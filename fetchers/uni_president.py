...
class UniPresidentFetcher(CompanyFetcher):
    """統一企業 爬蟲"""

    company_id = "uni_president"
    company_name = "統一企業"
    news_url = "https://www.統一企業.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        logger.info(f"Parsed {len(documents)} news from 統一企業")
        return documents
