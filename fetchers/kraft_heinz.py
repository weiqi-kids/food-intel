...
class KraftHeinzFetcher(CompanyFetcher):
    """Kraft Heinz 爬蟲"""

    company_id = "kraft_heinz"
    company_name = "Kraft Heinz"
    news_url = "https://www.kraftheinz.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.kraftheinz.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from Kraft Heinz")
        return documents
