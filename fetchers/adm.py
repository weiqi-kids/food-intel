...
class AdmFetcher(CompanyFetcher):
    """Archer-Daniels-Midland 爬蟲"""

    company_id = "adm"
    company_name = "Archer-Daniels-Midland"
    news_url = "https://www.archer-daniels-midland.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.archer-daniels-midland.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from Archer-Daniels-Midland")
        return documents
