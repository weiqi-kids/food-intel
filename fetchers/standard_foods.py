...
class StandardFoodsFetcher(CompanyFetcher):
    """佳格食品 爬蟲"""

    company_id = "standard_foods"
    company_name = "佳格食品"
    news_url = "https://www.佳格食品.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        logger.info(f"Parsed {len(documents)} news from 佳格食品")
        return documents
