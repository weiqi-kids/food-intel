...
class BungeFetcher(CompanyFetcher):
    """Bunge Global 爬蟲"""

    company_id = "bunge"
    company_name = "Bunge Global"
    news_url = "https://www.bungeglobal.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.bungeglobal.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from Bunge Global")
        return documents
