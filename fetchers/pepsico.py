...
class PepsicoFetcher(CompanyFetcher):
    """PepsiCo 爬蟲"""

    company_id = "pepsico"
    company_name = "PepsiCo"
    news_url = "https://www.pepsico.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        logger.info(f"Parsed {len(documents)} news from PepsiCo")
        return documents
