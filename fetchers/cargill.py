...
class CargillFetcher(CompanyFetcher):
    """Cargill 爬蟲"""

    company_id = "cargill"
    company_name = "Cargill"
    news_url = "https://www.cargill.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        logger.info(f"Parsed {len(documents)} news from Cargill")
        return documents
