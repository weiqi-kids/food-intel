...
class MondelezFetcher(CompanyFetcher):
    """Mondelēz International 爬蟲"""

    company_id = "mondelez"
    company_name = "Mondelēz International"
    news_url = "https://www.mondelēzinternational.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.mondelēzinternational.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from Mondelēz International")
        return documents
