...
class GeneralMillsFetcher(CompanyFetcher):
    """General Mills 爬蟲"""

    company_id = "general_mills"
    company_name = "General Mills"
    news_url = "https://www.generalmills.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.generalmills.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from General Mills")
        return documents
