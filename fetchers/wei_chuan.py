...
class WeiChuanFetcher(CompanyFetcher):
    """味全食品 爬蟲"""

    company_id = "wei_chuan"
    company_name = "味全食品"
    news_url = "https://www.味全食品.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        logger.info(f"Parsed {len(documents)} news from 味全食品")
        return documents
