...
class NestleFetcher(CompanyFetcher):
    """Nestlé 爬蟲"""

    company_id = "nestle"
    company_name = "Nestlé"
    news_url = "https://www.nestlé.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        logger.info(f"Parsed {len(documents)} news from Nestlé")
        return documents
