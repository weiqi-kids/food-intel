...
class CostcoFetcher(CompanyFetcher):
    """Costco Wholesale 爬蟲"""

    company_id = "costco"
    company_name = "Costco Wholesale"
    news_url = "https://www.costcowholesale.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.costcowholesale.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from Costco Wholesale")
        return documents
